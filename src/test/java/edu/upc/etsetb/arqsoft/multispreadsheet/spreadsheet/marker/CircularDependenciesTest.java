...
public class CircularDependenciesTest extends SuperClassForTests {
    ...
    public CircularDependenciesTest() throws InvalidSpreadsheetTypeException, InvalidCellContentGenerationTypeException {
        super();
        numInstances++;
        if (numInstances == 1) {
    ...
    public void test_02_IndirectCircularDependency() throws Exception {
        ...
        try {
            ...
            try {
                ...
                this.instance.getCellContentAsDouble("B1");
