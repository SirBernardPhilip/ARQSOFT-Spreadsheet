...
import edu.upc.etsetb.arqsoft.multispreadsheet.spreadsheet.usecases.marker.ISpreadsheetFactoryForChecker;
...
public class DependentCellsTest extends SuperClassForTests {
        ...
        public DependentCellsTest() throws InvalidSpreadsheetTypeException, InvalidCellContentGenerationTypeException {
                super();
                numInstances++;
                if (numInstances == 1) {
        ...
        public void test_03_DependentCellReferencedAsFunctionRangeArgument() throws Exception {
                ...
                this.printlnAlways("\nChecking the proper update of cells that contain "
                                ...
                                + "that contains the cell whose content is modified. Total value (over 10): "
                                + valorTotal);
                try {
